...
namespace sgm
{
    namespace cl
    {
        ...
        StereoSGM<input_type>::StereoSGM(int width,
                                         ...
                                         cl_device_id cl_device,
                                         const Parameters &param)
            : m_width(width), m_height(height), m_max_disparity(disparity_size), m_output_depth_bits(output_depth_bits), m_src_pitch(src_pitch), m_dst_pitch(dst_pitch), m_cl_ctx(ctx), m_cl_device(cl_device), m_params(param)
        {
